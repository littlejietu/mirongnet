  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-7">
            <h3 class="first-child"><span>About Rooster.Inc</span></h3>
            <p>
            ...
            <a class="btn-animate btn-style btn-d btn-primary" href="contact-us.html">Contact Us</a>
            <br /><br />
          </div>
          <div class="col-sm-5">
        ...
        <div class="row our-team-p">
          <div class="col-sm-12">
            <h3 class="headline"><span>Our Team</span></h3>
            <div class="row">
              <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="team-member text-center">
                  <img class="img-responsive center-block" src="img/team/team1.jpg" alt="...">
                  <div class="info">
              ...
              <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="team-member text-center">
                  <img class="img-responsive center-block" src="img/team/team2.jpg" alt="...">
                  <div class="info">
              ...
              <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="team-member text-center">
                  <img class="img-responsive center-block" src="img/team/team3.jpg" alt="...">
                  <div class="info">
              ...
              <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="team-member text-center">
                  <img class="img-responsive center-block" src="img/team/team4.jpg" alt="...">
                  <div class="info">
