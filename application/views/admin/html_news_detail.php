  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="javascript:void(0);" class="current"><span>更新文章详情</span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="post" name="settingForm" id="settingForm" action="<?php echo ADMIN_SITE_URL.'/html_page/make_news_detail'?>" target="resultIframe">
