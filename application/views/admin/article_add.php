  ...
  <form id="article_form" method="post" name="articleForm" action="<?php echo ADMIN_SITE_URL.'/article/save'?>" onsubmit="return doValid();">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" for="cate_id"><?php echo lang('article_add_class');?>:11</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation"><?php echo lang('article_add_content');?>:112</label></td>
        </tr>
        <tr class="noborder">
