  ...
  <?php include("inc/nav.php");?>
    ...
    <div class="wrapper">
      ...
      <div class="container">
	    <div class="row">
          <div class="col-sm-12">
            <h3 class="first-child"><span>Service Center</span></h3>
          </div>
        </div> <!-- / .row -->
	    <div class="row">
            <div class="col-sm-4">
