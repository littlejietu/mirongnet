			...
			<div class="gallery clearfix">
			 <ul class="list-unstyled">
			  <li><a href="#"><img src="<?php echo _get_cfg_path('img');?>avatar-1.jpg" style="width:60px;height:60px;" alt="..."></a></li>
				...
				<li><a href="#"><img src="<?php echo _get_cfg_path('img');?>avatar-7.jpg" style="width:60px;height:60px;" alt="..."></a></li>
				<li><a href="#"><img src="<?php echo _get_cfg_path('img');?>avatar-8.jpg" style="width:60px;height:60px;" alt="..."></a></li>				
			 </ul>
			</div>
          </div><!-- / .Recent Tweets -->
