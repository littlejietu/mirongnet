		...
		$menuList = array(
			...
			'left' =>array(
				...
				6 => array(
					...
					'text' => lang('nc_website'),
					'list' => array(
						array('args'=>',article_class,website',							'text'=>lang('nc_article_class')),
						...
						array('args'=>',page,website',									'text'=>'页面管理'),
						array('args'=>',cases,website',									'text'=>'案例展示'),
						array('args'=>',case_class,website',							'text'=>'案例分类'),
				...
				7 => array(
					...
					'list' => array(
						...
						array('args'=>',nav,operation',									'text'=>'导航管理'),
